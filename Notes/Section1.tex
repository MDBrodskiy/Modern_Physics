...
\begin{itemize}
  ...
  \item Spacetime Diagrams
    ...
    \begin{itemize}
      ...
      \item Bob and Alice's worldlines, respectively, would look as follows:
        ...
        \begin{figure}[h!]
          \centering
          \include{Figures/BAstdiagram.tex}
  ...
  \item The Energy-Momentum Relationship can be defined as:
    ...
    \begin{itemize}
      ...
      \item This means the rest energy for an electron is $E_0=.511[\si{\mega\eV}]$

      \item The momentum of an electron (at $v=.75c$) would be:

        $$p=\dfrac{m_ev}{\sqrt{1-\frac{v^2}{c^2}}}$$
        $$p=\frac{.511\cdot .75}{\sqrt{1-.75^2}}$$
        $$p=.58\left[ \frac{\si{\mega\eV}}{c} \right]$$

    \end{itemize}

  \item The following are some important units to understand:

    \begin{itemize}

      \item Energy: $\si{\mega\eV}$

      \item Momentum: $\si{\mega\eV}/c$

      \item Mass: $\si{\mega\eV}/c^2$
